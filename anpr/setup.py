...
def check_anpr_model():
    """Check if ANPR.pt exists."""
    model_path = Path(__file__).parent / "models" / "ANPR.pt"
    if not model_path.exists():
        print(f"WARNING: ANPR.pt not found at {model_path}. Please place the custom ANPR.pt model in the models/ directory.")

def main():
    """Run setup tasks."""
    print("Starting setup for ANPR project...")
    create_directories()
